  ...
  remove(e) {
    if (e) {
      ...
      if (t) {
        ...
        c[t] = n.filter((o) => o.toastId !== e), !c[t].length && !De(t) && te(t, false), ke(), se(() => {
...
function nt({
  ...
  return n ? o = oe.spinner() : a === false ? o = void 0 : G(a) ? o = A(a) : q(a) ? o = a(s) : de(a) ? o = Ne(a, s) : ae(a) || ze(a) ? o = a : tt(t) && (o = oe[t](s)), o;
}
var at = () => {
};
...
function st(e) {
  const t = B(false), n = B(false), a = B(false), o = B(V.Enter), s = F({
    ...e,
...
var rt = W({
  ...
  setup(e) {
    ...
    return () => l("div", P({
      ...
      innerHTML: e.content
    }) : e.content])]), (e.closeButton === void 0 || e.closeButton === true) && l(Ke, {
      theme: e.theme,
      closeToast: (m) => {
