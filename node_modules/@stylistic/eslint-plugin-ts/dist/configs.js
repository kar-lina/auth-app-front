...
const baseRule$h = utils.getESLintCoreRule("block-spacing");
...
const baseRule$g = utils.getESLintCoreRule("brace-style");
var braceStyle = utils.createRule({
  ...
  create(context) {
    ...
    const sourceCode = context.sourceCode;
    const rules = baseRule$g.create(context);
...
const baseRule$f = utils.getESLintCoreRule("comma-dangle");
...
var commaDangle = utils.createRule({
  ...
  create(context, [options]) {
    const rules = baseRule$f.create(context);
    const sourceCode = context.sourceCode;
...
const baseRule$e = utils.getESLintCoreRule("indent");
...
var indent = utils.createRule({
  ...
  create(context, optionsWithDefaults) {
    ...
    const rules = baseRule$e.create(contextWithDefaults);
...
const baseRule$d = utils.getESLintCoreRule("key-spacing");
const baseSchema$1 = Array.isArray(baseRule$d.meta.schema) ? baseRule$d.meta.schema[0] : baseRule$d.meta.schema;
...
const baseRule$c = utils.getESLintCoreRule("keyword-spacing");
const baseSchema = Array.isArray(baseRule$c.meta.schema) ? baseRule$c.meta.schema[0] : baseRule$c.meta.schema;
...
const baseRule$b = utils.getESLintCoreRule("lines-around-comment");
...
var linesAroundComment = utils.createRule({
  ...
  create(context, [_options]) {
    ...
    const rules = baseRule$b.create(proxiedContext);
    return {
      Program(node) {
        rules.Program(node);
        comments.forEach((token) => {
...
const baseRule$a = utils.getESLintCoreRule("lines-between-class-members");
...
var linesBetweenClassMembers = utils.createRule({
  ...
  create(context, [firstOption, secondOption]) {
    const rules = baseRule$a.create(context);
...
const baseRule$9 = utils.getESLintCoreRule("no-extra-parens");
var noExtraParens = utils.createRule({
  ...
  create(context) {
    const sourceCode = context.sourceCode;
    const rules = baseRule$9.create(context);
...
const baseRule$8 = utils.getESLintCoreRule("no-extra-semi");
...
const baseRule$7 = utils.getESLintCoreRule("object-curly-newline");
...
const baseRule$6 = utils.getESLintCoreRule("object-curly-spacing");
...
const baseRule$5 = utils.getESLintCoreRule("object-property-newline");
