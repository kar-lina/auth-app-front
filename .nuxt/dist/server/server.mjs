...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-Dv4X2r4K.js").then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    component: () => import("./_nuxt/login-cyvR_jY4.js").then((m) => m.default || m)
  },
  {
    name: "profile",
    path: "/profile",
    component: () => import("./_nuxt/profile-Br900PRL.js").then((m) => m.default || m)
  },
  {
    name: "settings",
    path: "/settings",
    component: () => import("./_nuxt/settings-D67qs8iO.js").then((m) => m.default || m)
  },
  {
    name: "sign-up",
    path: "/sign-up",
    component: () => import("./_nuxt/sign-up-DPWh8l5l.js").then((m) => m.default || m)
  }
];
