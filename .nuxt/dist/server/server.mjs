import { effectScope, shallowReactive, reactive, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, version, unref, h, ref, shallowRef, onServerPrefetch, computed, toValue, defineComponent, provide, createElementBlock, markRaw, watch, isRef, isReactive, toRaw, nextTick, onScopeDispose, toRefs, isReadonly, isShallow, useSSRContext, Suspense, Fragment, Transition, defineAsyncComponent, mergeProps, onErrorCaptured, createVNode, resolveDynamicComponent, createApp } from "vue";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-DhDs76sv.js").then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    component: () => import("./_nuxt/login-BCklXwNj.js").then((m) => m.default || m)
  },
  {
    name: "profile",
    path: "/profile",
    component: () => import("./_nuxt/profile-C6R91wsd.js").then((m) => m.default || m)
  },
  {
    name: "settings",
    path: "/settings",
    component: () => import("./_nuxt/settings-Cwlrj8gG.js").then((m) => m.default || m)
  },
  {
    name: "sign-up",
    path: "/sign-up",
    component: () => import("./_nuxt/sign-up-DYxqng_R.js").then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-DLyXNUro.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-Cvn4B80-.js").then((r) => r.default || r));
