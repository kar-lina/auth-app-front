...
import { mergeProps, useSSRContext, defineComponent, withCtx, createTextVNode, unref, createVNode } from "vue";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(authenticated)) {
        ...
        _push(ssrRenderComponent(_component_nuxt_link, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<img src="https://images.pexels.com/photos/17410093/pexels-photo-17410093.jpeg?auto=compress&amp;cs=tinysrgb&amp;w=600&amp;lazy=load"${_scopeId}>`);
            } else {
              return [
                createVNode("img", { src: "https://images.pexels.com/photos/17410093/pexels-photo-17410093.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load" })
              ];
            }
          }),
          _: 1
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<p>Copyright © ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} - All right reserved</p></aside></footer>`);
}
...
//# sourceMappingURL=default-Y-x6ncbU.js.map
