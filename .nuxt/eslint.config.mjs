...
export const options = resolveOptions({
  ...
  "dirs": {
    ...
    "servers": [],
    "root": [
      "/Users/lina/Documents/dev/auth/auth-app-front"
    ],
    "src": [
      ""
    ]
