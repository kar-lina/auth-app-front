import { _ as __nuxt_component_0 } from './nuxt-layout-BDwzfyRu.mjs';
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<input${ssrRenderAttrs((_temp0 = mergeProps({
              ...
              placeholder: "Email",
              autofocus: "off"
            }), mergeProps(_temp0, ssrGetDynamicModelProps(_temp0, unref(email)))))}${_scopeId}></label><div class="w-[20%] text-xs text-error text-left pl-4"${_scopeId}>${ssrInterpolate(unref(errors).email)}</div></div><div${_scopeId}><label class="input input-bordered flex items-center gap-2 mb-1"${_scopeId}>`);
            ...
            }), mergeProps(_temp1, ssrGetDynamicModelProps(_temp1, unref(password)))))}${_scopeId}></label><div class="w-[20%] text-xs text-error text-left pl-4"${_scopeId}>${ssrInterpolate(unref(errors).password)}</div></div>`);
            if (unref(showOtp)) {
              ...
              createVNode("div", { class: "p-5 md:p-10 text-center rounded-xl bg-white" }, [
                ...
                createVNode("form", {
                  ...
                  createVNode("div", null, [
                    ...
                    createVNode("div", { class: "w-[20%] text-xs text-error text-left pl-4" }, toDisplayString(unref(errors).email), 1)
                  ]),
                  createVNode("div", null, [
                    createVNode("label", { class: "input input-bordered flex items-center gap-2 mb-1" }, [
                    ...
                    createVNode("div", { class: "w-[20%] text-xs text-error text-left pl-4" }, toDisplayString(unref(errors).password), 1)
                  ]),
...
//# sourceMappingURL=login-cyvR_jY4.mjs.map
