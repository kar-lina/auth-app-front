...
const layouts = {
  animated: () => import('./animated-ydklIp_L.mjs').then((m) => m.default || m),
  auth: () => import('./auth-DGmqKbAw.mjs').then((m) => m.default || m),
  default: () => import('./default-paGscscj.mjs').then((m) => m.default || m)
};
...
//# sourceMappingURL=nuxt-layout-jMGp9Z4m.mjs.map
